...
class LFUCache {
    ...
    public void updatefreqList(Node node){
        ...
        DoublyLinkedList newList = freqListMap.getOrDefault(node.count, new DoublyLinkedList());
    ...
    public void put(int key, int value) {
        ...
        if(keyNodeMap.containsKey(key)){
            ...
            if(currsize == capacity){
                DoublyLinkedList listt = freqListMap.get(minfreq);
                Node nodeToRemove = listt.tail.prev;
                listt.removeNode(nodeToRemove);
